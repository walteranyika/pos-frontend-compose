...
class CustomerService(private val httpClient: HttpClient) {
     ...
     */
    suspend fun getCustomers(): Result<List<CustomerResponse>> = safeApiCall {
     ...
     */
    suspend fun createCustomer(request: CreateCustomerRequest): Result<CustomerResponse> = safeApiCall {
